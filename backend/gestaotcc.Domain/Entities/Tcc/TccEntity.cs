...
public class TccEntity
{
    ...
    public TccEntity(long id, string? title, string? summary, string status, DateTime creationDate, ICollection<UserTccEntity> userTccs, ICollection<TccInviteEntity> tccInvites)
    {
        this.Id = id;
        this.Title = title;
